 ...
 #   timeBinned, magnitudeBinned = genBinnedLines([time, magnitude])
  ...
  #  print recentMin
    ...
    for i, data in enumerate(datain):
        ...
        # plt.plot(time2, magnitude2, 'o', ms=2)
        # plt.gca().invert_yaxis()
        # plt.show()
...
lcTimesV, lcMagsV = findRelMagnitudesAndPlot(file_in, datain, period, 0, cal1Mag, cal2Mag)
lcTimesV = [x + 30 * period for x in lcTimesV]
plt.plot(lcTimesB, lcMagsB, 'o', ms=2, label="B")
plt.plot(lcTimesV, lcMagsV, 'o', ms=2, label="V")
